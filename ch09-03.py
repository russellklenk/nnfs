...
# for a single neuron. Includes a simplification step and representation of the
...
# Simplifying, we have:
drelu_dz    = dvalue * (1.0 if z > 0 else 0.0)
drelu_di0   = drelu_dz * weights[0]
drelu_di1   = drelu_dz * weights[1]
drelu_di2   = drelu_dz * weights[2]
drelu_dw0   = drelu_dz *  inputs[0]
drelu_dw1   = drelu_dz *  inputs[1]
drelu_dw2   = drelu_dz *  inputs[2]
drelu_dbias = drelu_dz
print(drelu_di0, drelu_dw0, drelu_di1, drelu_dw1, drelu_di2, drelu_dw2, drelu_dbias)

# And representing the gradients as vectors:
di = [drelu_di0, drelu_di1, drelu_di2]
