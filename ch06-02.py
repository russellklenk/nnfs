#!/usr/bin/env python
# Attempt at "optimization" via random weight adjustments.
...
# - For vertical_data, loss decreases and accuracy increases.
# - For spiral_data, very little progress is made (likely due to getting stuck in a local minimum).
# Notice that we are very literally searching a space for the minimum value of the loss function.
iteration_count = 100000
for iteration in range(iteration_count):
    # Adjust the weights and biases by a small amount.
    ...
    if loss < lowest_loss:
        ...
        best_biases_layer1  = dense_layer1.biases.copy()
        lowest_loss = loss
    else: # Revert to prior 'best' state
        dense_layer0.weights = best_weights_layer0.copy()
        dense_layer1.weights = best_weights_layer1.copy()
        dense_layer0.biases  = best_biases_layer0.copy()
        dense_layer1.biases  = best_biases_layer1.copy()
